# Catspot — Product Requirements Document (PRD) + North Star

This is the consolidated source of truth for the Catspot project. It combines competitive intelligence, technical architecture, and product direction.

**Working title:** Catspot (placeholder — pick something you like).  
**Inspiration:** `xyz.catchcat.app` (CatchCat) — real-world cat spotting & collection game.  
**Date:** 2026-07-29  
...
*Prepared by the K3 swarm + consolidation. Research and subagent outputs live in `docs/research/`.*
